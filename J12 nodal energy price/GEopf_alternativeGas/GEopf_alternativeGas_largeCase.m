...
gasFlowSOCcons = [
    - gasFlowMax <= gasFlow_sum <= gasFlowMax;
    repmat(-gasFlowMax,[1,nGasType]) <= gasFlow <= repmat(gasFlowMax, [1,nGasType]);
...
options = sdpsettings('verbose',2,'solver','mosek', 'debug',1,'usex0',0,'gurobi.qcpdual',1);
